...
🌐 Live-Ansicht meines Projekts: 👉 [QuizApp](https://elenah-2026.github.io/quiz-app/)
...
```bash
git clone https://github.com/ElenaH-2026/quiz-app.git
```
...
> [!IMPORTANT]
> Details zur Lizenz findest du in der [LICENSE.md](https://github.com/ElenaH-2026/quiz-app?tab=License-1-ov-file).
